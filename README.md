...
```bash
skelantic generate -o "tools/skelantic_types.py"
```

This will create a single Python file containing your custom `RepoGraph` and all template models:
...
# -t specifies the Python module path of your generated types
skelantic run -p "tools.processors" -t "tools.skelantic_types"
```
